...
uint32_t math_6c3d_add(
      uint32_t a,uint32_t b,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer math_6c3d_hello(
      RustBuffer name,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_math_6c3d_rustbuffer_alloc(
      int32_t size,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_math_6c3d_rustbuffer_from_bytes(
      ForeignBytes bytes,
    RustCallStatus *_Nonnull out_status
    );
void ffi_math_6c3d_rustbuffer_free(
      RustBuffer buf,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_math_6c3d_rustbuffer_reserve(
